...
# [play2perfect] one colour / label per Sharpa fingertip (tab10; first four match the LEAP palette)
from .robot_spec import ARM_JOINT_NAMES, FINGERTIP_COLORS, FINGERTIP_LABELS  # noqa: E402
...
def plot_action_comparison(
    ...
    if highlight is None:
        highlight = [n for n in joint_names if n not in ARM_JOINT_NAMES]   # [play2perfect] hand joints
    cols = 4
